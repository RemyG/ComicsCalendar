 ...
 * @method     ChildUserQuery orderByAuthKey($order = Criteria::ASC) Order by the auth_key column
 * @method     ChildUserQuery orderByLastSeenOn($order = Criteria::ASC) Order by the last_seen_on column
 *
 * @method     ChildUserQuery groupById() Group by the id column
 * @method     ChildUserQuery groupByLogin() Group by the login column
 * @method     ChildUserQuery groupByPassword() Group by the password column
 * @method     ChildUserQuery groupByEmail() Group by the email column
 * @method     ChildUserQuery groupByAuthKey() Group by the auth_key column
 * @method     ChildUserQuery groupByLastSeenOn() Group by the last_seen_on column
 *
 * @method     ChildUserQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method     ChildUserQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method     ChildUserQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildUserQuery leftJoinUserSerie($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserSerie relation
 * @method     ChildUserQuery rightJoinUserSerie($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserSerie relation
 * @method     ChildUserQuery innerJoinUserSerie($relationAlias = null) Adds a INNER JOIN clause to the query using the UserSerie relation
 *
 * @method     ChildUserQuery leftJoinUserIssue($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserIssue relation
 * @method     ChildUserQuery rightJoinUserIssue($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserIssue relation
 * @method     ChildUserQuery innerJoinUserIssue($relationAlias = null) Adds a INNER JOIN clause to the query using the UserIssue relation
 *
 * @method     \UserSerieQuery|\UserIssueQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUser findOneByAuthKey(string $auth_key) Return the first ChildUser filtered by the auth_key column
 * @method     ChildUser findOneByLastSeenOn(string $last_seen_on) Return the first ChildUser filtered by the last_seen_on column *
 ...
 * @method     ChildUser requireOneByAuthKey(string $auth_key) Return the first ChildUser filtered by the auth_key column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByLastSeenOn(string $last_seen_on) Return the first ChildUser filtered by the last_seen_on column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUser[]|ObjectCollection findByAuthKey(string $auth_key) Return ChildUser objects filtered by the auth_key column
 * @method     ChildUser[]|ObjectCollection findByLastSeenOn(string $last_seen_on) Return ChildUser objects filtered by the last_seen_on column
...
abstract class UserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'comicslist', $modelName = '\\User', $modelAlias = null)
    {
    ...
    public function filterByAuthKey($authKey = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_AUTH_KEY, $authKey, $comparison);
    }
    ...
    public function filterByLastSeenOn($lastSeenOn = null, $comparison = null)
    {
        if (is_array($lastSeenOn)) {
            ...
            if (isset($lastSeenOn['min'])) {
                $this->addUsingAlias(UserTableMap::COL_LAST_SEEN_ON, $lastSeenOn['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($lastSeenOn['max'])) {
                $this->addUsingAlias(UserTableMap::COL_LAST_SEEN_ON, $lastSeenOn['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_LAST_SEEN_ON, $lastSeenOn, $comparison);
    }
    ...
    public function filterByUserSerie($userSerie, $comparison = null)
    {
        if ($userSerie instanceof \UserSerie) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $userSerie->getUserId(), $comparison);
    ...
    public function filterByUserIssue($userIssue, $comparison = null)
    {
        if ($userIssue instanceof \UserIssue) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $userIssue->getUserId(), $comparison);
